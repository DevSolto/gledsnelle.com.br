    ...
    <>
      <section id="inicio" className="bg-main bg-cover bg-top text-[#E31313] w-screen flex flex-col justify-end items-center pt-10 lg:pt-0">
        ...
        <div className="max-w-[1024px] h-min w-screen flex flex-col items-center justify-end gap-5 lg:hidden object-scale-down">
          ...
          <div className="bg-avatar d-flex bg-cover bg-center sm w-full max-w-[550px] lg:w-1/2 h-[350px] lg:h-[800px]"></div>
          <Link to="/plano-de-governo" className="px-5">
            <img src={button} alt="Botão de acesso ao plano de governo" />
          </Link>
        </div>
        ...
        <div className="max-w-[1024px] w-screen items-end justify-end gap-5 lg:grid grid-cols-2 hidden object-scale-down">
          <div className="h-full flex flex-col items-center justify-center gap-5">
            ...
            <Link to="/plano-de-governo" className="px-5 flex justify-center">
              <img src={button} alt="Botão de acesso ao plano de governo" className="w-2/3" />
            </Link>
          </div>
          <div className="bg-avatar-2 d-flex bg-contain bg-no-repeat bg-bottom h-[380px] -mb-5 mt-20"></div>
        </div>
      </section>
    </>
  );
