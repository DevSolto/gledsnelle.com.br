...
export function Footer() {
  return (
    ...
    >
      <div className="text-white px-6 w-screen flex items-center justify-between">
        <p className=" w-full text-sm">586.329.804-91 - Av. Manoel de Barros, 86, Centro, Remigio - PB 58.398-000</p>
